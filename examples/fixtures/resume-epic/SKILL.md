---
name: resume-epic
description: Exercise resume-context generation for the CLI by providing a small but durable runtime state tree. Activate when testing epic resume behavior.
metadata:
  source:
    repo: github.com/agentepics/epics.sh
    path: examples/fixtures/resume-epic
    ref: main
---

# Resume Epic

Use this epic when you need a compact fixture for state, plan, and log recovery. `EPIC.md` is the authoritative source for lifecycle, state model, guardrails, and resume behavior.
