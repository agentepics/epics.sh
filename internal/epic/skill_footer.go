...
const (
	...
	CanonicalSkillFooterURL     = "https://github.com/agentepics/agentepics/blob/v0.5.2/footer.md"
	CanonicalSkillFooterMarker  = "<!-- epics-canonical-footer: https://github.com/agentepics/agentepics/blob/v0.5.2/footer.md -->"
